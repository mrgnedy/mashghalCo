...
class _BottomNavigationBarScreenState extends State<BottomNavigationBarScreen> {
    ...
    Future.delayed(Duration(seconds: 2), () {
      showDialog(
          ...
          builder: (context) => GeneralDialog(
              content: body, toDOFunction: navigateToNotificationScreen));
    });
  }

  navigateToNotificationScreen() =>
      Navigator.pushNamed(context, isAuth? OrderScreen.routeName : ReservationScreen.routeName);
  getTokenCallback(String token) {
    _fcmToken = token;
    print('TOKEEEEEN $_fcmToken');
  }
  ...
  void initState() {
    ...
    FirebaseNotifications firebaseNotifications = FirebaseNotifications.handler(
        onMessage,
        navigateToNotificationScreen,
        navigateToNotificationScreen,
        getTokenCallback)
