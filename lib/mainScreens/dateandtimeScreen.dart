...
class _DateTimeScreenState extends State<DateTimeScreen> {
  Future<void> _showBill(
      var total, List arr, List<ServicesIds> ids, int ownerId) {
    return showDialog(
        context: context,
        builder: (BuildContext context) {
          return ShowBillWidget(
              total: total,
              list: Provider.of<Reservations>(context).order,
              ids: Provider.of<Reservations>(context).ordersId,
              ownerId: ownerId);
        });
  }
