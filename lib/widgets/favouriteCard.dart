...
class FavouriteCard extends StatelessWidget {
  ...
  FavouriteCard({this.callback, this.id, this.favId, this.title, this.image, this.rate});
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return GeneralDialog(
            content: 'هل بالفعل تريد حذف المشغل من المفضله ؟',
  ...
  void _deleteFav(BuildContext context) async {
    await Provider.of<More>(context, listen: false).deleteFav(favId).then((_){
      callback();
    });
